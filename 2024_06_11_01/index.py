...
from ttkthemes import ThemedTk ##2
from tkinter import messagebox
from tools import CustomMessagebox


class Window(ThemedTk):       ##2--建立Window視窗
    def __init__(self,theme:str|None,**kwargs):    #**kwargs:沒有限定名稱的呼叫
        super().__init__(**kwargs)
        self.title("BMI計算機")
        #self.configure(bg='#D3D3D3')  ##背景色
        #self.geometry("350x350+100+50")   #不建議設大小
        ...
        titleFrame.pack(padx=100,pady=(0,20))  #把容器撐開
        #========================================================
        ...
        label_height.grid(row=1, column=0, padx=5, pady=5,sticky=tk.E)  #sticky:靠哪邊
    ...
    def show_bmi_result(self):
        ...
        #except UnboundLocalError:
            #messagebox.showwarning("Warning","欄位未填寫")
        except ValueError:
            messagebox.showwarning("Warning","格式錯誤,欄位未填寫")
        except Exception:
